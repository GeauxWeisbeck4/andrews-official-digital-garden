...
const Post = ({ data, size = "medium", pinned = false }: Props) => {
    ...
    return (
        ...
        >
            <article className={`bg-white dark:bg-gray-950 p-8 pb-4 rounded-md outline outline-1 outline-black dark:outline-transparent dark:hover:outline-white hover:outline-2 space-y-6 group transition-all duration-200 ${
